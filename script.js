...
const t = {
  en: {
    ...
    heroDesc: "Interior painting, exterior painting, skim coat, putty, and waterproofing with clean workmanship and premium results.",
    ...
    servicesDesc: "Clean wall preparation, smooth finishing, durable paint work, and practical waterproofing solutions.",
    service1Title: "Interior Painting",
    service1Desc: "Smooth and clean painting for bedrooms, living rooms, halls, and other indoor spaces.",
    service2Title: "Exterior Painting",
    service2Desc: "Durable exterior coatings that improve appearance and protect walls from weather.",
    service3Title: "Skim Coat & Putty",
    service3Desc: "Wall leveling and finishing for a better final paint result and cleaner surface.",
    service4Title: "Waterproofing",
    service4Desc: "Solutions for damp walls, water leakage, and moisture protection.",
    galleryTag: "Work",
    ...
    contactDesc: "Call or message directly for painting, skim coat, putty, and waterproofing inquiries.",
  ...
  si: {
    ...
    heroDesc: "අභ්‍යන්තර පින්තාරු කිරීම, බාහිර පින්තාරු කිරීම, ස්කිම් කෝට්, පුට්ටි සහ ජල ආරක්ෂණය — පිරිසිදු වැඩ සහ ප්‍රිමියම් ප්‍රතිඵල සමඟ.",
    ...
    servicesDesc: "පිරිසිදු බිත්ති සූදානම, සුමට නිමාව, දිගුකාලීන පේන්ට් වැඩ සහ ප්‍රායෝගික ජල ආරක්ෂණ විසඳුම්.",
    service1Title: "අභ්‍යන්තර පින්තාරු කිරීම",
    service1Desc: "නිදන කාමර, විසිත්ත කාමර, ශාලා සහ අනෙකුත් ඇතුළත ස්ථාන සඳහා සුමට හා පිරිසිදු පින්තාරු කිරීම.",
    service2Title: "බාහිර පින්තාරු කිරීම",
    service2Desc: "කාලගුණයෙන් බිත්ති ආරක්ෂා කරමින් පෙනුම වැඩිදියුණු කරන දිගුකාලීන බාහිර ආවරණ.",
    service3Title: "ස්කිම් කෝට් සහ පුට්ටි",
    service3Desc: "වඩා හොඳ අවසාන පේන්ට් ප්‍රතිඵලයක් සඳහා බිත්ති මට්ටම් කිරීම සහ නිමාව.",
    service4Title: "ජල ආරක්ෂණය",
    service4Desc: "තෙත් බිත්ති, ජල කාන්දුවීම් සහ තෙතමනයට විසඳුම්.",
    galleryTag: "වැඩ",
    ...
    contactDesc: "පේන්ට්, ස්කිම් කෝට්, පුට්ටි සහ ජල ආරක්ෂණ inquiries සඳහා සෘජුව call හෝ message කරන්න.",
